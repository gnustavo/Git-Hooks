...
GitHub|https://raw.githubusercontent.com/gnustavo/Git-Hooks/next/scripts/githooks-docker.sh|githooks-docker.sh>
like this:
...
siblings, such as in Bitbucket and in GitLab. Gerrit, on the other hand, keeps
its repositories in a hierarchy and you should define the C<REPO_ROOT> variable
with a fixed string.
