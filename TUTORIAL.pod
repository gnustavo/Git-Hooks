...
Git::Hooks uses the L<Git> module which is part of the C<git>
...
Also, read the section about L</The GITPERLLIB environment variable> to
know what to do in case your Perl can't find the L<Git> module.
